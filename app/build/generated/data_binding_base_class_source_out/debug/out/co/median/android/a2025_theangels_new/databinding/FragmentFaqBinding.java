...
public final class FragmentFaqBinding implements ViewBinding {
  ...
  private FragmentFaqBinding(@NonNull ScrollView rootView, @NonNull ExpandableListView faqList) {
  ...
  public static FragmentFaqBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.faq_list;
      ExpandableListView faqList = ViewBindings.findChildViewById(rootView, id);
      if (faqList == null) {
        break missingId;
      }

      return new FragmentFaqBinding((ScrollView) rootView, faqList);
    }
